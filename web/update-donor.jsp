...
<%
        ...
        if(session.getAttribute("u_type").toString().equals("-1")){
            response.sendRedirect("update-receiver.jsp");
        }
        String update = "";
        String error = "";
                    ...
                    if(email==null && fullname==null){
                        ...
                        q = "UPDATE `users` set `u_email`='"+email+"', `u_birthday`='"+bday+"', `u_blood`='"+blood+"', `u_name`='"+fullname+"', `u_country`="+country+", `u_city`='"+city+"', `u_contacts`='"+contacts+"', `u_allergies`='"+allergies+"', `u_medication`='"+medications+"' where u_id="+session.getAttribute("u_id").toString();
                        try{
...
<form class="form-horizontal" method="POST">
                  <fieldset>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-3">
                          <textarea rows=3 class="form-control" id="inputAllergies" name="inputMedications" required><%=user.getString("u_medication")%></textarea>
                      </div>
                    </div>
                    <div class="form-group">
