...
inputContacts
                    ...
                    */
                    ...
                    if(email==null && pass1==null && pass2==null && name==null){
                        ...
                        q = "INSERT INTO `users`(`u_username`, `u_email`, `u_pass`, `u_type`, `u_birthday`, `u_sex`, `u_blood`, `u_name`, `u_country`, `u_city`, `u_contacts`, `u_allergies`, `u_medication`, `u_bloodqty`, `u_blooddate`) 	VALUES ( '"+name+"', '"+email+"', md5('"+pass1+"'), -1, '"+bday+"', "+sex+", '"+blood+"', '"+fullname+"', "+country+", '"+city+"', '"+contacts+"', '"+allergies+"', '', "+qty+", '"+nextday+"')";
                        try{
...
%>
                ...
                <form class="form-horizontal" method="POST">
                  <fieldset>
                    <legend>Sign up as a receiver</legend>
                    ...
                    <div class="form-group">
                      <label for="inputQuantity" class="col-lg-2 control-label">Quantity of blood required</label>
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" type="text" name="inputQuantity" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required>
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="inputNextday" class="col-lg-2 control-label">Date when blood is required</label>
                        <div class="controls col-lg-3">
                            <input name="inputNextday" id="datepicker2" type="text" class="form-control" readonly maxlength="10" pattern="[0-9]{4}[-][0-9]{2}[-][0-9]{2}" title="2012-12-20 Format" required aria-required=”true”>
                       </div>
                    </div>
                    <div class="form-group">
